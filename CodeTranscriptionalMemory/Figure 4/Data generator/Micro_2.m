...
%%
num = xlsread('4.10_nonrel_micro_36pairs.xlsx',1);
...
% %%
% 
% for i = 1:2:50;%size(yTOT,2)
%     y1 = yTOT(:,i);
%     y2 = yTOT(:,i+1);
%     fin1 = find(y1,1,'last');
%     fin2 = find(y2,1,'last');
%     subplot(5,5,round(i/2))
%     plot(x(1:fin1),y1(1:fin1),x(1:fin2),y2(1:fin2))
%     xlim([0 max(x(fin1),x(fin2))])
% end
