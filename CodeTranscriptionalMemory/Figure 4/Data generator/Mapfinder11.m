ClonekeyN = {'Rasa12_S1_STRSa1','Pgk_S1_STRSa1','Jam2_S1_STRSa1','Jarid2_S1_STRSa1','Rbpj_S1_STRSa1','Nono_S1_STRSa1','Dstn_S1_STRSa1','Sprouty_S1_STRSa1','Tfpd2_S1_STRSa1_1'};

zN = 5%:length(Clonekey)
...
%%
[num]=xlsread('4.10_mother_daughter_48p.xlsx'); % pgk21 
...
yTOT = num1;
x = (0:5:(5*size(yTOT,1)-1))'/60; % define time points (in hours)

X = X(1:size(yTOT,2)*3+9);
%%
itlimit1 = 120;
...
save([char(ClonekeyN(zN)),'_MD_HMCprelim'])